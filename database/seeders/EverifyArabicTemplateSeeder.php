...
class EverifyArabicTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        [
            ...
            'description' => 'أخبار مثيرة للاهتمام مباشرة في صندوق الوارد الخاص بك',
            'game_id' => 1,
            'attachment_type_id' => 1,
            'is_phishing'=> 1,
            'reason'=>'محتوى مشبوه غير مطمئن',
            'short_reason'=>'الايميل مشبوه',
            'sender' => 'asde@faconts.com',
                          ...
                          <tr>
                            <td>
                              <div class='text' style='padding: 0 2.5em; text-align: center;'>
                                <h2>يرجى التحقق من بريدك الإلكتروني</h2>
                                <h3>صفقات مذهلة ، تحديثات ، أخبار مثيرة للاهتمام مباشرة في صندوق الوارد الخاص بك</h3>
                                <p>
                                  <a href='http://aredfg-form.com' class='btn btn-primary'>نعم! اشترك لي </a>
                                </p>
                              </div>
                            </td>
                          </tr>
                  ...
                  <table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='margin: auto;'>
                    ...
                    <tr>
                      <td class='bg_light' style='text-align: center;'>
                        <p>No longer want to receive these email? You can <a href='#' style='color: rgba(0,0,0,.8);'>Unsubscribe here</a>
                        </p>
                      </td>
                    </tr>
                  </table>
