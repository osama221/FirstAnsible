...
class AnnouncementsRealTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $template = [
                ...
                'sender' => 'security@announcements.soundcloud.com>',
                  ...
                  <table align='center' style='width:600px; margin: auto; text-align: center;'>
                    <tbody>
                      ...
                      <tr style='text-align: center;' width='100'>
                        <td style='padding: 35px 0; font-size: 13px; width: 100px;' width='100'><a href='https://soundcloud.com/' style='font-size: 13px; width: 100px;' width='100'><img style='font-size: 13px; width: 100px;' width='100'
                                ...
                                <tbody>
                                    <tr style='height: 38px;'>
                                        <td
                                            ...
                                            <span
                                                style='color: #ff6600; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 600;'><a href='https://soundcloud.com/'
                            ...
                            <table cellspacing='0' cellpadding='0'>
                                <tr>
                                    <td style='border-radius: 2px;' bgcolor='#ff5500'>
                                        <a href='https://soundcloud.com/' target='_blank' style='padding: 8px 12px; border: 1px solid #ff5500;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;'>
                                          listen now
                                        </a>
                                    </td>
                                </tr>
