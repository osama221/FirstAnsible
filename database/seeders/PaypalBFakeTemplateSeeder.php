...
class PaypalBFakeTemplateSeeder extends Seeder
{
    /**
                        ...
                        <tr>
                          <td style='padding: 0px 20px 20px 20px'>
                            <p dir='ltr' style='
                                  ...
                                  word-break: break-word;
                                '>
                              If your question has already been answered, please go to the Message Center and end this
                                ...
                                <tr>
                                  <td style='
                                    ...
                                    <a style='
                                        ...
                                        ' href='{host}/execute/page/{link}' target='_blank' rel='noopener'>Go to the
                                      Message Center</a>
                                  </td>
                                </tr>
                              </tbody>
