...
class FacebookLoginArabicTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $template =
            [
                'language' => 'ar',
                'title' => 'تنبيه تسجيل الدخول الى فيسبوك',
                'description' => 'تم تسجيل الدخول إلى حسابك مؤخرًا من متصفح أو جهاز غير معروف. هل كان هذا أنت',
                'game_id' => 1,
                'attachment_type_id' => 9,
                'is_phishing'=> 1,
                'reason'=>'البريد الإلكتروني المرسل لا علاقة له بالفيسبوك',
                'short_reason'=>'بريد إلكتروني مشبوه',
                'sender' => 'alert@facebook-security.com',
                'template'=> "<html dir='ltr'>
                <head>
                ...
                <div style='max-width: 100%;'>
                   <div style='margin:0;padding:0' dir='rtl' bgcolor='#ffffff'>
                      <table cellspacing='0' cellpadding='0' width='100%;' id='m_-5140787778864602591email_table' border='0'
                         style='border-collapse:collapse'>
                         <tbody dir='rtl'>
                            <tr dir='rtl'>
                               <td dir='rtl' id='m_-5140787778864602591email_content'
                                  style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;background:#ffffff'>
                                  <table dir='rtl' cellspacing='0' cellpadding='0' width='100%' style='border-collapse:collapse'>
                                     <tbody dir='rtl'>
                                        <tr dir='rtl'>
                                           <td dir='rtl' height='20' style='line-height:20px' colspan='3'>&nbsp;</td>
                                        </tr>
                                        <tr>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td width='100%'><a
                                                          ...
                                                          target='_blank'>تنبيه تسجيل الدخول</a></td>
                                                    </tr>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    <tr>
                                                       <td><span class='m_-5140787778864602591mb_text'
                                                          style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;font-weight:bold;color:#141823'>مرحبا
                                                          #name,</span>
                                                       </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                       <td><span class='m_-5140787778864602591mb_text'
                                                          style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823'>تم تسجيل الدخول إلى حسابك مؤخرًا من متصفح أو جهاز غير معروف. هل هذا انت</span></td>
                                                    </tr>
                                                    <tr>
                                                       <td height='14' style='line-height:14px'>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                       <td><span style='font-size:10px;font-weight:bold;color:#777'>تسجيل دخول جديد</span></td>
                                                    </tr>
                                                    <tr>
                                                       <td height='14' style='line-height:14px'>&nbsp;</td>
                                                    </tr>
                                                             ...
                                                             <tbody>
                                                                <tr class='m_-5140787778864602591ib_row'>
                                                                   ...
                                                                   <td width='100%' valign='top'
                                                                      ...
                                                                      January 21, 2021 at 18:33:21</span>
                                                                   </td>
                                                                </tr>
                                                             </tbody>
                                                          </table>
                                                             ...
                                                             <tbody>
                                                                <tr class='m_-5140787778864602591ib_row'>
                                                                   ...
                                                                   <td width='100%' valign='top'
                                                                      ...
                                                                      class='m_-5140787778864602591ib_mid'><span
                                                                      class='m_-5140787778864602591mb_text'
                                                                      style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823'>جوجل كروم
                                                                      </span>
                                                                   </td>
                                                                </tr>
                                                             </tbody>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    <tr>
                                                       <td class='m_-5140787778864602591mb_blk'>
                                                          ...
                                                          <center>
                                                          <font size='3'><span
                                                             style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#ffffff;font-size:14px;line-height:14px'>مراجعة تسجيل الدخول</span>
                                                          </font>
                                                          </center>
                                                          </a>
                                                          </td>
                                                       ...
                                                       <td class='m_-5140787778864602591mb_blk'>
                                                          ...
                                                          <center>
                                                          <font size='3'><span
                                                             style='font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#525252;font-size:14px;line-height:14px'>إدارة التنبيهات
                                                          </span>
                                                          </font>
                                                          </center>
                                                          </a>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    <tr>
                                                       <td
                                                          ...
                                                          تم إرسال هذه الرسالة <a href=''
                                                             style='color:#3b5998;text-decoration:none'
                                                             target='_blank'>ahmed@ahmed.com</a>. إذا كنت لا ترغب في تلقي رسائل البريد الإلكتروني هذه من Facebook في المستقبل ، من فضلك <a href=''
                                                             style='color:#3b5998;text-decoration:none' target='_blank'
                                                             data-saferedirecturl='#link11'>إلغاء الاشتراك</a>.<br>Facebook,
                                                          Inc., Attention: Community Support, Menlo Park, CA 94025
                                                       </td>
                                                    </tr>
                                                 </tbody>
                                              </table>
