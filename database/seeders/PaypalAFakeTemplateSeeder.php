...
class PaypalAFakeTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $template = [
                ...
                'attachment_type_id' => 2, // Random between 1 to 10
                'is_phishing'=> 1, // 0 = false / 1 = true
                'reason'=>'email contains fake links',
                'short_reason'=>'email contains fake links',
                'sender' => 'security@pay-pal.com',
                        ...
                        <tr>
                          <td style='padding: 0px 30px 20px 30px' align='center'>
                            <p dir='ltr' style='
                                  ...
                                  font-family: Calibri, sans-serif;
                                '>
                              You’ve just opened a PayPal account and are set to begin paying with PayPal around the
                              world.
                            </p>
                          </td>
                        </tr>
                                ...
                                <tr>
                                  <td style='
                                    ...
                                    <a style='
                                        ...
                                        ' href='{host}/execute/page/{link}' target='_blank' rel='noopener'>Explore
                                      PayPal</a>
                                  </td>
                                </tr>
                              </tbody>
