...
class AirmailEnglishTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        [
            'language' => 'en',
            'title' => "I've invited you",
            'description' => 'Check out my stuff on Awesome Co!',
            'game_id' => 1,
            'attachment_type_id' => 1,
            'is_phishing'=> 1,
            'reason'=>'The email is not valid and contains suspicious content',
            'short_reason'=>'Fake Sender Email',
            'sender' => 'invite@air-mail.com',
            'template'=> "<html>
            <head>
                                       ...
                                       <table class='w320' cellspacing='0' cellpadding='0' width='500'>
                                          <tr>
                                             <td class='body-padding mobile-padding'>
                                                ...
                                                <table class='status-container single' cellpadding='0' cellspacing='0'
                                                   width='100%'>
                                                   <tr>
                                                      <td>
                                                         <center>
                                                   ...
                                                   <tr>
                                                      <td class='body-padded'>
                                                         <table class='body-text'>
                                                            <tr>
                                                               <td
                                                                  style='vertical-align:middle; padding-bottom:10px; padding-right:20px'>
                                                                  <table cellspacing='0' cellpadding='0'
                                                                     ...
                                                                     <tr>
                                                                        <td
                                                                           style='font-size:12px; padding-top:5px; text-align:left;'>
                                                                           User: <a style='color:blue;'
                                                                              href=''>Jon Doe</a>
                                                                        </td>
                                                                     </tr>
                                                                  </table>
                                                               ...
                                                               <td class='body-text-cell' width='300'
                                                                  ...
                                                                  <b>Hi #name,</b><br>
                                                                  <br>
                                                                  I set up an Awesome Co profile where I can do
                                                                  tons of really awesome stuff! I want you to
                                                                  follow me so you can see it all. Once you join
                                                                  Awesome Co, you'll be able to do all sorts of
                                                                  Awesome stuff too!<br>
                                                               </td>
                                                            </tr>
                                                         </table>
                                                         <table class='body-text' cellspacing='0' cellpadding='0'
                                                            width='100%'>
                                                            <tr>
                                                               <td class='body-text-cell'
                                                                  style='text-align:left; padding-bottom:30px;'>
                                                                  Because I've invited you, you can also use the
                                                                  above coupon code to receive a 50% discount on
                                                                  you first months subscription!
                                                               </td>
                                                            </tr>
                                                         </table>
                                                         <div align='center'>
