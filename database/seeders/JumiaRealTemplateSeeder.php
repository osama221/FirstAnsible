...
class JumiaRealTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $template = [
                ...
                'sender' => 'security@info.jumia.com.eg>',
                                                                ...
                                                                <div style='height:100%;width: 100%; vertical-align:middle; display:table; text-align: center'
                                                                    valign='center'><span
                                                                        style='display:table-cell; vertical-align: middle; text-align: center'><a
                                                                            href='https://www.jumia.com.eg/?gclid=Cj0KCQjwsZKJBhC0ARIsAJ96n3VdcroPOABj2DZkZNkStomSWjJyqYTuHpn-DVwPYKwFrfW1C5a_e44aAgliEALw_wcB'
