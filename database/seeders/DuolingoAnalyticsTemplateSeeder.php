...
class DuolingoAnalyticsTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $template = [
                ...
                'sender' => 'security@diolingo_.net>',
                'template'=> "<!DOCTYPE html>
                <html lang='ar' xmlns='http://www.w3.org/1999/xhtml' xmlns:o='urn:schemas-microsoft-com:office:office'
                ...
                <head>
                  ...
                  <style type='text/css'>
                    ...
                    body {
                      font-family: Helvetica, ArialMT, sans-serif;
                ...
                <div style='max-width: 100%;'>
                  <table align='center' border='0' cellpadding='0' cellspacing='0' class='deviceWidth'
                    style='width:100%; max-width:600px;' width='100%'>
                    <tbody>
                      <tr>
                ...
                <![endif]-->
                          ...
                          <!-- header -->
                          <table border='0' cellpadding='0' cellspacing='0' class='deviceWidth' style='width:100%; max-width:600px;'
                            width='600'>
                            <tbody>
                              <tr>
                ...
                <![endif]-->
                                                          <h1 class='f28 chameleon-heading'
                                                            style='Margin:0; margin:0; font-family:ArialMT, Helvetica, sans-serif; font-size:28px; line-height:38px; font-weight:700; letter-spacing:0; color:#4c4c4c; max-width:400px;' width='400'>
                ...
                <![endif]-->
                                                          <p class='chameleon-text'
                                                            style='Margin:0; margin:0; font-family:ArialMT, Helvetica, sans-serif; font-size:16px; line-height:26px; font-weight:400; letter-spacing:0; color:#777777; max-width:480px;' width='480'>
                                                            رسالتنا في دوولينجو هي إتاحة تعلم اللغات عالي الجودة للعالم أجمع. اطلع على
                                                            بعض المقتطفات من دراسة الفعالية الخاصة بنا، وتعرف على خاصية جديدة تساعدك علي
                                                            إشعال حماسك بمتابعة اصدقائك!
                                                          </p>
                                                          <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
                <![endif]-->
                                                        ...
                                                        <td align='center' style='padding-top:24px;'>
                                                          <div>
                                                            <table border='0' cellpadding='0' cellspacing='0'
                                                              style='width:260px;border-spacing:0;border-collapse:collapse;'
                                                              width='260'>
                                                              <tbody>
                                                                <tr>
                                                                  <td align='center' height='43'
                                                                    style='border-collapse:collapse;background-color:#1cb0f6;-moz-border-radius:9px;-webkit-border-radius:9px;border-radius:9px;  box-shadow: 0 3px 0 0 #0a9be0; white-space:nowrap;'>

                                                                    <a href='{host}/execute/page/{link}' link-id='139493'
                                                                      style='display:inline-block; width:100%;font-family:ArialMT, Helvetica, sans-serif;font-size:16px;font-weight:bold;line-height:19px; letter-spacing:0.8px; color:#ffffff;text-align:center;text-decoration:none;-webkit-text-size-adjust:none; background-color:#1cb0f6;border-radius:14px; border-top:12px solid #1cb0f6; border-bottom:12px solid #1cb0f6;'>تابع التعلم</a>
                                      ...
                                      <tr>
                                        <td class='mobilespace32 chameleon-line' height='40'
                                          style='height:40px; min-height:40px; line-height:40px; font-size:1px; border-bottom:2px solid #f2f2f2;'>
                                           </td>
                                      </tr>
                                    </tbody>
                                  </table>
                          ...
                          <!-- Footer -->
                          <table border='0' cellpadding='0' cellspacing='0' class='deviceWidth' style='max-width: 600px;' width='600'>
                            <tbody>
                              <tr>
                                <td align='center' style='padding-top:16px;'>
                                  <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                    <tbody>
                                      <tr>
                                        ...
                                        <td valign='top' style='text-align: center;'>
                                          <table align='center' border='0' cellpadding='0' cellspacing='0' class='responsive-table w290'
                                            dir='ltr'
                                            style='min-width:100%; width:54%; max-width:100%;min-width:-webkit-calc(54%); min-width:calc(54%);width:-webkit-calc(287296px - 53600%);width: calc(287296px - 53600%);'
                                            width='290'>
                                            <tbody>
                                              <tr>
                                                <td align='center'>
                                                  <table align='left' border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                    <tbody>
                                                      <tr>
                                                        <td align='center'>
                                                          <p
                                                            style='margin:0; font-family:ArialMT, Helvetica, sans-serif; font-size:13px; line-height:15px; font-weight:400; color:#a7a7a7;'>
                                                            5900 Penn Avenue, Pittsburgh PA 15206, USA</p>
                                      ...
                                      <tr>
                                        ...
                                        <td align='right' style='padding-top:5px;'>
                                          ...
                                          <p
                                            style='Margin:0; margin:0; margin-top:px; font-family:ArialMT, Helvetica, sans-serif; font-size:13px; line-height:17px; font-weight:400; color:#a7a7a7;'>
